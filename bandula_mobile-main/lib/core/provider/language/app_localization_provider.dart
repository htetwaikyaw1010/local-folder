...
import '../../db/common/master_translation_dao.dart';
...
class AppLocalization extends ChangeNotifier {
  ...
  Future<void> loadFromDatabase() async {
    final MasterTranslationDao dao = MasterTranslationDao.instance;
    final MasterResource<Map<String, dynamic>> resource =
  ...
  //   final MasterResource<dynamic> resource = await MasterApiService()
  //       .getTranslationByLanguageCode(loginUserId: '1', languageId: id);
