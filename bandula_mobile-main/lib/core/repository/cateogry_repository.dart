...
class CategoryRepository extends MasterRepository {
  CategoryRepository(
      {required MasterApiService apiService, required CateogryDao dao}) {
  ...
  late CateogryDao _dao;

  Future<dynamic> insert(Category object) async {
    return _dao.insert(primaryKey, object);
  }

  Future<dynamic> update(Category object) async {
    return _dao.update(object);
  }

  Future<dynamic> delete(Category object) async {
  ...
  Future<void> loadDataList({
    ...
    await startResourceSinkingForList(
        ...
        serverRequestCallback: () async {
          return await _apiService.getCategoryList();
        });
